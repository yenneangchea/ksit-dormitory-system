...
import { API_BASE_URL, buildingsAPI, dashboardAPI, roomAssignmentsAPI, roomsAPI, type AssignmentBoard, type DashboardAnalytics as DashboardAnalyticsData, type DashboardSummary, type PasswordResetRequest, usersAPI } from '@/lib/api';
