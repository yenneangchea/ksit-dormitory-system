    ...
    <div className="min-h-screen bg-[#f8faf8] text-slate-800">
      ...
      <nav aria-label="ម៉ឺនុយសាធារណៈ" className="sticky top-0 z-40 hidden bg-[#147a5b] text-white shadow-md lg:block">
        <div className="mx-auto flex max-w-7xl items-center">
          ...
          <Link href="/about" className={`px-5 py-3 text-sm font-bold hover:bg-[#0f6047] ${active === 'about' ? 'bg-[#0f6047]' : ''}`}>អំពីវិទ្យាស្ថាន</Link>
          <a href="https://ksit.edu.kh/category/scholarship/" target="_blank" rel="noreferrer" className="px-5 py-3 text-sm font-bold hover:bg-[#0f6047]">កម្មវិធីសិក្សា និងអាហារូបករណ៍</a>
